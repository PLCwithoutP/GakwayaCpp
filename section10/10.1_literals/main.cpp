...
int main()
{
    ...
    // Assignment and functional do not catch that.
    ...
    std::cout << "The hex number 2 is : " << hex_number2 << std::endl;
    ...
    // more about strings as we progress in course.
    char char_literal {'c'};
