...
int main(int argc, char **argv)
{
    ...
    std::cout << std::endl;
    std::cout << "Comparing std::strings to C-strings" << std::endl;
    std::cout << "hello_str.size() : " << hello_str.size() << std::endl;
    std::cout << "std::strlen(c_string1) : " << std::strlen(c_string1) << std::endl;
    std::cout << hello_str << " == " << c_string1 << " (C-String) : " << (hello_str == c_string1) << std::endl;
    std::cout << c_string1 << " (C-String) == " << hello_str << " : " << (hello_str == c_string1) << std::endl;
    std::cout << c_string1 << " (C-String) >= " << hello_str << " : " << (hello_str == c_string1) << std::endl;
    std::cout << c_string1 << " (C-String) <= " << hello_str << " : " << (hello_str == c_string1) << std::endl;

    // Be careful about char arrays not terminated with null character
    std::cout << std::endl;
    std::cout << "Comparing with non-null terminated char array" << std::endl;
    ...
    std::cout << "Changing hello_str" << std::endl;
    hello_str = "kello";
