...
int main(int argc, char **argv)
{
 ...
 /*    // Concatenation
    ...
    char dest[50] = "Hello ";
    // const char dest[50] = "Hello "; // Compiler error
    char src[50] = " World!";
    std::strcat(dest,src); // Some compilers think these functions are unsafe!
...
/*     // More concatenation
    ...
    // What's going to happend in std::strcat is that the source is going to be appended to dest, and the 
    // process will start by overriding the null character in the dest
...
/*     // strncat : like strcat but how many characters that will be concatenated is specified
    ...
    // This is a pattern you'll se a lot in C++ code out there
    std::cout << std::strncat(dest2, source2, 6) << std::endl;

    // Or you can do std::strncat separately and print des2
