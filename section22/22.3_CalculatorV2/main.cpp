...
int main(int argc, char* argv[])
{
    ...
    if (argc != 4)
    {
        ...
        std::cerr << "Program_name a + b" << std::endl;
    ...
    {
        std::cout << "Please use valid numbers (different than zero) for the first and second parameters" << std::endl;
        return 0;
    }
    ...
    {
        std::cerr << operation << " is not a valid option." << std::endl;
        return 0;
    }
