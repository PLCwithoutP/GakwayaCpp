...
int main(int argc, char **argv)
{
    ...
    std::cout << "&scores[0] : " << &scores[0] << std::endl; // 1st Element
    ...
    // scores = &number; // The array name is a pointer, but a special pointer that
                         // kind of the entire array. You'll get the error : incompatible
                         // types of 'int*' to 'int[10]'
    
    std::cout << "p_score : " << p_score << std::endl; // Pointer
    
    // std::size() does not work for pointers
