...
int main(){
    ...
    double number5 {192400023.0f}; // Error : still a float

    std::cout << "number4 : " << number4 << std::endl;
    std::cout << "number5 : " << number5 << std::endl;

    // Scientific notation
    // What we have seen so far is terms of floating point types
    ...
    double number8 {1.924e8}; // can ommit the lower 00023
                              // for simplicity
