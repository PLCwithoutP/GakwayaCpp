...
int main(){
    ...
    std::cout << std::endl;
    std::cout << "Table with fill character" << std::endl;
    ...
    std::cout << "pos_num : " << pos_number << std::endl;
    std::cout << "neg_num : " << neg_number << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "pos_int in different base formats" << std::endl;
    std::cout << "pos_int (dec) : " << std::dec << pos_int << std::endl;
    std::cout << "pos_int (hex) : " << std::hex << pos_int << std::endl;
    std::cout << "pos_int (oct) : " << std::oct << pos_int << std::endl;

    std::cout << std::endl;
    std::cout << "neg_int in different base formats" << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "double_var in different base formats" << std::endl;
    ...
    // setprecision() : the number of digits printed out for a floating point. Default precision depends on data type
    ...
    // If the precision is bigger than supported by the type, it'll just print garbage value

    // showpoint and noshowpoint : show trailing zeros if necessary
    // Force output to show point / no point
